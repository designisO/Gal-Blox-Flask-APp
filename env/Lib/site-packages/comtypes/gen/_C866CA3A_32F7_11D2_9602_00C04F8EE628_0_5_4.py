...
__all__ = [
    'DISPID_SDKGetBinaryValue', 'SBONone', 'SPSInterjection',
    'SVEBookmark', 'SAFT8kHz8BitStereo', 'SAFT8kHz16BitMono',
    'Speech_Max_Pron_Length', 'SPAUDIOSTATUS',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPACommit', 'SGRSTTWord',
    'SDA_Two_Trailing_Spaces', 'ISpRecoGrammar2',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechPhoneConverter', 'SECFNoSpecialChars',
    'SPEI_INTERFERENCE', 'SECFIgnoreCase', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPCPhoneToId', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechRecoResultTimes',
    'ISpXMLRecoResult', 'ISpObjectTokenCategory',
    'DISPID_SpeechRecognizer', 'SRADynamic', 'SPEI_MAX_SR',
    'ISpeechLexiconPronunciation', 'DISPID_SGRs_NewEnum',
    'SpeechAddRemoveWord', 'DISPID_SRCPause', 'eLEXTYPE_RESERVED10',
    'SP_VISEME_10', 'SPSHORTCUTPAIRLIST', 'SpeechEngineProperties',
    'DISPID_SAVolume', 'DISPID_SRCESoundEnd',
    'SPRS_ACTIVE_USER_DELIMITED', 'SGDSActiveWithAutoPause',
    'SAFTADPCM_22kHzStereo', 'SAFTCCITT_uLaw_22kHzMono',
    'SP_VISEME_21', 'SpeechStreamFileMode', 'DISPID_SRCState',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVP_0',
    'tagSPPROPERTYINFO', 'SVP_5', 'DISPID_SRCResume',
    'SAFT44kHz8BitMono', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SOTs_NewEnum', 'SGLexical', 'SAFT32kHz8BitStereo',
    'eLEXTYPE_PRIVATE17', 'SAFTADPCM_11kHzMono', 'SPLOADOPTIONS',
    'eLEXTYPE_PRIVATE4', 'DISPIDSPTSI_SelectionLength',
    'ISpeechPhraseReplacements', 'SAFT24kHz16BitStereo',
    'SDA_No_Trailing_Space', 'SPWAVEFORMATTYPE', 'SAFT22kHz16BitMono',
    'SPSEMANTICFORMAT', 'DISPID_SpeechObjectToken', 'SPRULESTATE',
    'ISpRecognizer3', 'DISPID_SpeechPhraseBuilder', 'SREStreamStart',
    'DISPID_SPRuleFirstElement', 'DISPID_SPRuleId',
    'SpeechRegistryLocalMachineRoot', 'SDKLLocalMachine',
    'SPGS_EXCLUSIVE', 'SWPKnownWordPronounceable',
    'eLEXTYPE_PRIVATE9', 'DISPID_SGRAddResource', 'SpeechVoiceEvents',
    'SPWF_INPUT', 'SPBINARYGRAMMAR', 'SAFT8kHz8BitMono',
    'SpeechWordType', 'SSTTTextBuffer',
    'SpeechCategoryPhoneConverters',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SGDSActive',
    'SRTStandard', 'SpMMAudioOut', 'STSF_CommonAppData',
    'SPVPRI_ALERT', 'SPRS_ACTIVE', 'SpeechFormatType', 'SPSNoun',
    'ISpeechDataKey', 'SPEI_TTS_BOOKMARK', 'DISPID_SVEStreamStart',
    'SPFM_OPEN_READONLY', 'SITooQuiet', 'SPEI_MIN_TTS',
    'DISPID_SpeechPhraseReplacements', 'ISpStreamFormat',
    'SECFDefault', 'SVEPhoneme', 'SpeechRecognitionType',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGState', 'ISpRecognizer2',
    'SVEVoiceChange', 'DISPID_SFSClose', 'SECNormalConfidence',
    'DISPID_SVEBookmark', 'DISPID_SVEViseme', 'DISPID_SAStatus',
    'SPBO_NONE', 'SGRSTTTextBuffer', 'SPPS_RESERVED4',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SWFEExtraData',
    'DISPID_SPERetainedStreamOffset', 'SSFMCreate',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SPANumberOfElementsInResult', 'SVPNormal',
    'SPRST_INACTIVE_WITH_PURGE', 'SPPS_Noun', 'SPSModifier',
    'SAFT48kHz8BitStereo', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechGrammarRuleState', 'SpeechSpecialTransitionType',
    'DISPID_SRCCreateGrammar', 'DISPID_SPILanguageId',
    'DISPID_SGRsCount', 'SP_VISEME_7', 'SPRS_INACTIVE',
    'DISPID_SRGDictationLoad', 'SP_VISEME_4', 'ISpeechLexicon',
    'SPBO_PAUSE', 'DISPID_SGRSTType', 'SpeechRetainedAudioOptions',
    'SAFTText', 'DISPID_SpeechLexicon', 'DISPIDSPTSI',
    'DISPID_SRGetPropertyNumber', '_ISpeechRecoContextEvents',
    'SPWT_PRONUNCIATION', 'DISPID_SPEsCount',
    'DISPID_SPIEnginePrivateData', 'SRTReSent', 'ISpPhraseAlt',
    'SpeechRuleState', 'SRTEmulated', 'SpeechGrammarTagWildcard',
    'SREAudioLevel', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRCESoundStart', 'SPPROPERTYINFO', 'SP_VISEME_5',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPIGrammarId',
    'DISPID_SpeechPhraseRule', 'ISpeechObjectTokenCategory',
    'DISPID_SpeechVoice', 'SPDKL_DefaultLocation', 'SGSEnabled',
    'DISPID_SVSpeak', 'DISPID_SOTIsUISupported', 'SREInterference',
    'Speech_Default_Weight', 'DISPID_SVStatus', 'SPGRAMMARSTATE',
    'SRATopLevel', 'SPEI_TTS_PRIVATE', 'SpeechRecognizerState',
    'SPEI_RESERVED1', 'SSFMOpenForRead', 'SPPHRASERULE',
    'ISpeechRecoResult2', 'SPXRO_SML', 'DISPID_SBSFormat',
    'SAFT16kHz16BitMono', 'SVP_1', 'SPEI_START_INPUT_STREAM',
    'DISPID_SVAudioOutput', 'SPXMLRESULTOPTIONS', 'ISpProperties',
    'SAFT22kHz8BitStereo', 'DISPID_SRGCmdLoadFromResource',
    'eLEXTYPE_USER_SHORTCUT', 'SREPropertyStringChange',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SABufferInfo', 'ISpAudio',
    'DISPID_SpeechVoiceEvent', 'ISpeechVoice', 'DISPID_SRCRecognizer',
    'SPAR_Medium', 'SpeechRecoEvents', 'DISPID_SGRSTRule',
    'DISPID_SpeechAudioFormat', 'DISPID_SBSSeek', 'SLODynamic',
    'SASClosed', 'SPSSuppressWord', 'DISPID_SpeechLexiconWords',
    'DISPID_SAFType', 'DISPID_SOTMatchesAttributes',
    'DISPID_SLPLangId', 'ISequentialStream', 'DISPID_SVGetVoices',
    'SP_VISEME_1', 'SAFTADPCM_8kHzMono', 'SpMemoryStream',
    'SAFT16kHz8BitMono', 'SPCONTEXTSTATE', 'SPPS_RESERVED3',
    'SpeechAudioFormatGUIDWave', 'ISpeechAudioFormat', 'SVEPrivate',
    'IInternetSecurityManager', 'SSSPTRelativeToCurrentPosition',
    'ISpeechPhraseRule', 'SREBookmark',
    'DISPID_SRSCurrentStreamPosition', 'SGLexicalNoSpecialChars',
    'SpPhoneConverter', 'DISPID_SRGSetTextSelection', 'SPWT_LEXICAL',
    'SVP_8', 'ISpeechRecoResult', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPELexicalForm', 'DISPIDSPRG',
    'DISPID_SRRAudio', 'SECHighConfidence', 'SVSFPersistXML',
    'SVSFIsFilename', 'DISPID_SPPEngineConfidence', 'ISpStream',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCEPhraseStart',
    'SpPhraseInfoBuilder', 'DISPID_SPIAudioStreamPosition',
    'SECFIgnoreWidth', 'DISPID_SGRSAddSpecialTransition',
    'eLEXTYPE_APP', 'SPSVerb', 'SRAORetainAudio',
    'DISPID_SpeechXMLRecoResult', 'SVSFDefault', 'SPEI_SOUND_START',
    'DISPID_SVEPhoneme', 'SPAR_Low', 'SpeechBookmarkOptions',
    'SVP_18', 'SPAS_PAUSE', 'DISPID_SOTSetId',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGCmdLoadFromMemory',
    'SAFT11kHz8BitMono', 'DISPID_SPAStartElementInResult',
    'DISPID_SVSInputSentencePosition', 'eLEXTYPE_RESERVED7',
    'SPLO_STATIC', 'DISPID_SGRSTransitions', 'STCInprocHandler',
    'SPAUDIOOPTIONS', 'DISPID_SPAPhraseInfo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SVSpeakStream', 'SGDSActiveUserDelimited',
    'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SLPPartOfSpeech', 'DISPID_SLWsItem',
    'DISPID_SABufferNotifySize', 'DISPID_SPPParent',
    'SpeechAudioVolume', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRRDiscardResultInfo', 'SAFTCCITT_ALaw_8kHzMono',
    'ISpeechLexiconPronunciations', 'SPEI_PHRASE_START',
    'DISPID_SVEStreamEnd', 'SpeechDisplayAttributes',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SWFEChannels',
    'SPEI_MIN_SR', 'DISPID_SGRSAddRuleTransition',
    'SpInprocRecognizer', 'SFTInput', 'SAFTGSM610_44kHzMono',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRRGetXMLErrorInfo', 'SVP_4',
    'DISPID_SLPSymbolic', 'SPINTERFERENCE_NOISE', 'SREPrivate',
    'DISPID_SVWaitUntilDone',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPINTERFERENCE_TOOSLOW', 'SPEI_MAX_TTS', 'eLEXTYPE_PRIVATE10',
    'UINT_PTR', 'SGSExclusive', 'SFTSREngine', 'SPCT_DICTATION',
    'DISPID_SDKOpenKey', 'SINoSignal', 'SVP_15',
    'DISPID_SpeechPhraseElement', 'SAFTNonStandardFormat',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechGrammarRule',
    'DISPID_SVSyncronousSpeakTimeout', 'SECFIgnoreKanaType', 'SPRULE',
    'SVEAllEvents', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechPhraseRules', 'DISPID_SABIEventBias',
    'DISPID_SPIStartTime', 'SECLowConfidence',
    'SpeechRecoContextState', 'SpeechAllElements',
    'eLEXTYPE_PRIVATE2', 'DISPID_SPIGetDisplayAttributes',
    'SPDKL_LocalMachine', 'DISPID_SASFreeBufferSpace',
    'ISpeechPhraseRules', 'DISPID_SVDisplayUI',
    'DISPID_SVSLastResult', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechLexiconProns', 'DISPID_SRGDictationSetState',
    'STCRemoteServer', 'SpeechTokenKeyUI', 'SAFT12kHz16BitStereo',
    'SPAS_RUN', 'DISPID_SPRNumberOfElements', 'ISpRecoContext',
    'DISPID_SPRuleChildren', 'ISpRecoGrammar', 'SVP_19',
    'DISPID_SPIProperties', 'DISPID_SRCEFalseRecognition',
    'SPSHT_NotOverriden', 'SRCS_Enabled', 'SGRSTTEpsilon',
    'SREPhraseStart', 'SVP_14', 'DISPID_SPRuleParent',
    'SpeechCategoryAudioIn', 'SpFileStream', 'SpeechInterference',
    'SpLexicon', 'SPPHRASE', 'SLOStatic', 'SP_VISEME_2',
    'ISpeechPhraseAlternate', 'eLEXTYPE_PRIVATE11', 'SPEI_RESERVED2',
    'ISpMMSysAudio', 'DISPID_SGRsAdd', 'ISpPhoneConverter',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SVGetAudioInputs',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFTGSM610_22kHzMono', 'SRAONone',
    'SpeechUserTraining', 'SAFTGSM610_11kHzMono', 'DISPID_SRIsShared',
    'eLEXTYPE_PRIVATE1', 'DISPID_SPEPronunciation',
    'SpeechVisemeType', 'ISpeechAudioStatus', 'ISpRecoContext2',
    'DISPID_SPRsCount', 'DISPID_SDKSetStringValue', 'DISPID_SPPsItem',
    'DISPID_SLPsCount', 'DISPID_SVAlertBoundary',
    'SAFTCCITT_uLaw_44kHzStereo', 'SAFTGSM610_8kHzMono',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechCustomStream',
    'DISPID_SVGetProfiles', 'SPXRO_Alternates_SML',
    'DISPID_SRGRecoContext', 'SDTProperty', 'SPSERIALIZEDRESULT',
    'ISpeechResourceLoader', 'SAFTNoAssignedFormat',
    'SpObjectTokenCategory', 'ISpResourceManager', 'SRESoundEnd',
    'SGRSTTDictation', 'SPPS_SuppressWord', 'DISPID_SLGetWords',
    'ISpeechLexiconWord', 'SDTLexicalForm', 'DISPID_SVSkip',
    'DISPID_SRGDictationUnload', 'DISPID_SRRAudioFormat',
    'SpeechLexiconType', 'DISPID_SABIBufferSize',
    '_ISpeechVoiceEvents', 'SPFM_OPEN_READWRITE', 'SPBOOKMARKOPTIONS',
    'SAFT16kHz16BitStereo', 'SpeechAudioProperties',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SVVolume',
    'SpeechDictationTopicSpelling', 'DISPID_SGRSTPropertyValue',
    'STCAll', 'SPPS_RESERVED2', 'SP_VISEME_18',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechGrammarTagDictation', 'DISPID_SPPFirstElement',
    'DISPID_SRCERecognition', 'SREAdaptation', 'IEnumString',
    'SPAO_RETAIN_AUDIO', 'SP_VISEME_20', 'SRTSMLTimeout',
    'SpeechAudioFormatType', 'SRAImport', 'ISpeechPhraseInfoBuilder',
    'SpeechCategoryAudioOut', 'SPEI_TTS_AUDIO_LEVEL',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SDKDeleteKey',
    'DISPID_SGRsCommit', 'SPPS_Modifier', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPPValue', 'SPAR_High', 'DISPID_SPIRule',
    'DISPID_SPERetainedSizeBytes', 'IEnumSpObjectTokens',
    'DISPID_SOTDataKey', 'SAFTADPCM_22kHzMono',
    'DISPID_SRAudioInputStream', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SVSFParseSsml', 'DISPID_SREmulateRecognition',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SGRSTs_NewEnum',
    'SAFTDefault', 'SAFT24kHz16BitMono', 'DISPID_SRStatus',
    'ISpObjectWithToken', 'ISpLexicon', 'ISpeechPhraseProperties',
    'STCLocalServer', 'DISPID_SPEEngineConfidence', 'SVP_2',
    'DISPID_SpeechPhraseProperty', 'ISpeechPhoneConverter',
    'DISPID_SRIsUISupported', 'SpAudioFormat', 'SPSLMA',
    'DISPID_SRCEPropertyNumberChange', 'SRTExtendableParse',
    'SPINTERFERENCE', 'DISPID_SPPConfidence',
    'DISPID_SRRSaveToMemory', 'SASRun', 'SP_VISEME_16',
    'SPAR_Unknown', 'SpShortcut', 'DISPID_SASNonBlockingIO',
    'DISPID_SMSALineId', 'SSFMCreateForWrite', 'SPCT_COMMAND',
    'ISpeechWaveFormatEx', 'DISPID_SVSPhonemeId',
    'DISPID_SRCRetainedAudioFormat', 'SAFT22kHz8BitMono',
    'DISPID_SRSetPropertyString', 'DISPID_SOTGetAttribute',
    'eWORDTYPE_DELETED', 'SDTDisplayText', 'SP_VISEME_8',
    'SP_VISEME_3', 'SPEI_SOUND_END', 'SAFT32kHz8BitMono',
    'SpeechPartOfSpeech', 'SAFTCCITT_uLaw_8kHzStereo', 'ISpPhrase',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPPId', 'SP_VISEME_12',
    '_SPAUDIOSTATE', 'ISpeechPhraseElement', 'ISpeechBaseStream',
    'SVP_16', 'ISpeechPhraseAlternates', 'DISPID_SpeechBaseStream',
    'ISpeechPhraseReplacement', 'DISPID_SRCEEndStream',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRSSupportedLanguages',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechDiscardType',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SVSInputWordPosition',
    'DISPID_SRGCmdSetRuleState', 'SPPHRASEPROPERTY', 'SPGS_DISABLED',
    'SVP_6', 'DISPID_SOTId', 'SRCS_Disabled', 'SVPAlert',
    'SPRECOSTATE', 'SPEI_END_SR_STREAM', 'DISPID_SPRulesItem',
    'DISPID_SLPsItem', 'DISPID_SRAudioInput',
    'SPEI_PROPERTY_STRING_CHANGE', 'WAVEFORMATEX', 'SPWORDLIST',
    'SVP_12', 'SPSHORTCUTPAIR', 'SPDKL_CurrentConfig', 'SVP_20',
    'SVP_3', 'SREFalseRecognition', 'DISPID_SPIGetText',
    'SpStreamFormatConverter', 'SPVISEMES', 'ISpeechRecoGrammar',
    'SPAO_NONE', 'SP_VISEME_6', 'SVPOver', 'SPEI_START_SR_STREAM',
    'SpeechCategoryRecoProfiles', 'DISPID_SRCCreateResultFromMemory',
    'SpeechGrammarWordType', 'SpeechRegistryUserRoot',
    'SPDKL_CurrentUser', 'DISPID_SPRDisplayAttributes',
    'DISPID_SGRSAddWordTransition', 'SITooFast', 'DISPID_SOTCSetId',
    'DISPID_SGRSTsItem', 'DISPID_SLPs_NewEnum', 'DISPID_SLWWord',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPWT_DISPLAY', 'SPPARTOFSPEECH',
    'SLTApp', 'SVESentenceBoundary', 'DISPID_SGRClear',
    'DISPID_SpeechLexiconWord', 'DISPID_SRSClsidEngine',
    '_RemotableHandle', 'ISpeechRecoContext', 'SASStop',
    'DISPID_SDKSetLongValue', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SAEventHandle', 'SPAUDIOBUFFERINFO', 'SAFT12kHz8BitMono',
    'DISPID_SPCIdToPhone', 'DISPID_SRCRetainedAudio', 'ISpEventSink',
    'SPEI_RECO_STATE_CHANGE', 'ISpeechRecognizer',
    'SpeechEngineConfidence', 'ISpeechLexiconWords',
    'DISPID_SRSAudioStatus', 'SPSNotOverriden', 'DISPID_SOTCId',
    'DISPID_SRCEInterference', 'DISPID_SOTDisplayUI',
    'SAFTADPCM_44kHzStereo', 'DISPID_SGRsDynamic', 'DISPID_SLWLangId',
    'Speech_StreamPos_RealTime', 'SpeechCategoryVoices',
    'DISPID_SLAddPronunciation', 'DISPID_SVEventInterests',
    'SPRST_ACTIVE', 'DISPID_SRGCmdSetRuleIdState', 'SPPS_LMA',
    'eLEXTYPE_PRIVATE19', 'SPEI_REQUEST_UI', 'SpMMAudioEnum',
    'DISPID_SDKEnumKeys', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechRecoContext', 'SAFT12kHz16BitMono',
    'DISPID_SVSInputWordLength', 'ISpeechFileStream',
    'eLEXTYPE_PRIVATE20', 'SpeechRecoProfileProperties',
    'DISPID_SGRsItem', 'SAFTCCITT_ALaw_11kHzStereo', 'ISpRecoResult',
    'SpTextSelectionInformation', 'DISPID_SVSVisemeId', 'SPBO_AHEAD',
    'SRAExport', 'ISpRecognizer',
    'SpeechPropertyNormalConfidenceThreshold', 'SVSFParseAutodetect',
    'SPAS_CLOSED', 'SAFT48kHz16BitMono', 'SPINTERFERENCE_TOOFAST',
    'SVP_9', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SPEAudioSizeTime',
    'DISPID_SDKGetStringValue', 'DISPID_SLGetGenerationChange',
    'DISPID_SRRSpeakAudio', 'SRSActive', 'SPEVENT',
    'DISPID_SMSAMMHandle', 'SVF_Stressed', 'DISPID_SPRuleName',
    'SRARoot', 'SAFT8kHz16BitStereo',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechRecoResultDispatch',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpUnCompressedLexicon',
    'SSTTDictation', 'DISPID_SRRecognizer', 'DISPID_SPISaveToMemory',
    'DISPID_SRGId', 'SVSFUnusedFlags', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpPhoneticAlphabetSelection', 'SPSERIALIZEDPHRASE',
    'SPSHT_EMAIL', 'SVSFNLPMask', 'IInternetSecurityMgrSite',
    'SpSharedRecoContext', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRCAudioInInterferenceStatus', 'SSTTWildcard',
    'STSF_AppData', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVSLastStreamNumberQueued', 'SSFMOpenReadWrite',
    'SPLEXICONTYPE', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRCEStartStream',
    'DISPID_SVEAudioLevel', 'STSF_LocalAppData', 'eLEXTYPE_PRIVATE16',
    'SPAS_STOP', 'SpeechPropertyAdaptationOn',
    'DISPID_SRCEventInterests', 'DISPID_SLWs_NewEnum',
    'SRERecognition', 'SpVoice', 'DISPID_SRCERequestUI',
    'DISPID_SpeechPhraseAlternates',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVPause',
    'ISpeechPhraseProperty', 'DISPID_SPPs_NewEnum',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SASState',
    ...
    'DISPID_SVEEnginePrivate', 'SpeechRuleAttributes',
    'DISPID_SRRTStreamTime', 'DISPID_SpeechMMSysAudio',
    'DISPIDSPTSI_ActiveLength', 'ISpeechXMLRecoResult',
    'DISPID_SDKDeleteValue', 'DISPID_SRSetPropertyNumber', 'SDTAudio',
    'ISpeechPhraseInfo', 'SPPS_NotOverriden', 'DISPID_SGRName',
    'SPPS_Interjection', 'SAFTADPCM_8kHzStereo', 'SVEWordBoundary',
    'SWPUnknownWordPronounceable', 'SpeechVoicePriority',
    'ISpeechRecoResultTimes', 'eLEXTYPE_PRIVATE6', 'SPVPRI_OVER',
    'SpeechTokenValueCLSID', 'DISPID_SPRules_NewEnum',
    'SREHypothesis', 'DISPID_SpeechDataKey', 'SRSEDone',
    'SAFT32kHz16BitStereo', 'SPGRAMMARWORDTYPE', 'SREAllEvents',
    'SpNullPhoneConverter', 'SPWORDTYPE', 'SPWF_SRENGINE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPRECORESULTTIMES',
    'SVSFIsXML', 'SPWORDPRONOUNCEABLE', 'SPSHT_Unknown',
    'SP_VISEME_0', 'SAFT11kHz8BitStereo', 'SGDisplay',
    'SPPS_Function', 'DISPID_SMSGetData', 'DISPID_SpeechMemoryStream',
    'SPFM_CREATE', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SPCLangId',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPIElements',
    'SECFEmulateResult', 'Speech_Max_Word_Length', 'SPCS_ENABLED',
    'DISPID_SOTGetDescription', 'DISPID_SPIAudioSizeTime',
    'SPPS_RESERVED1', 'SDTAlternates',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRSTWeight',
    'DISPID_SPRFirstElement', 'SGPronounciation', 'DISPID_SVEWord',
    'SPVOICESTATUS', 'ISpeechMMSysAudio', 'SVP_7',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPRuleEngineConfidence',
    'SP_VISEME_13', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SGRSTsCount', 'IStream', 'eLEXTYPE_PRIVATE15',
    'SAFT16kHz8BitStereo', 'SVP_11', 'DISPID_SpeechRecoResult',
    'ISpEventSource', 'SPEI_RECOGNITION', 'SP_VISEME_9',
    'SVSFVoiceMask', 'DISPID_SLWType', 'SWTDeleted',
    'SPPHRASEELEMENT', 'DISPID_SGRSRule', 'DISPID_SVRate',
    'SPRST_ACTIVE_ALWAYS', 'ISpStreamFormatConverter',
    'SRESoundStart', 'SPVPRI_NORMAL', 'SDTReplacement',
    'SpeechAudioState', 'SpeechVisemeFeature',
    'DISPID_SOTCGetDataKey', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPPChildren', 'DISPID_SPAsCount', 'SPDATAKEYLOCATION',
    'DISPID_SGRAttributes', 'SLTUser', 'SPPS_Verb',
    'SAFT44kHz16BitStereo', 'STCInprocServer', 'DISPID_SGRSTText',
    'SDA_One_Trailing_Space', 'SPRST_NUM_STATES',
    'DISPID_SGRAddState', 'DISPIDSPTSI_SelectionOffset',
    'ISpObjectToken', 'DISPID_SAFGuid',
    'ISpPhoneticAlphabetConverter', 'SPADAPTATIONRELEVANCE',
    'DISPID_SASCurrentSeekPosition', 'SPFILEMODE', 'SRSInactive',
    'DISPID_SRCERecognitionForOtherContext', 'SP_VISEME_11',
    'SASPause', 'SPFM_CREATE_ALWAYS', 'SpeechDataKeyLocation',
    'SVEStartInputStream', 'SAFT22kHz16BitStereo',
    'ISpeechCustomStream', 'DISPID_SOTsItem', 'SPEVENTENUM',
    'SPWORDPRONUNCIATION', 'SpCompressedLexicon', 'SPWORD',
    'DISPID_SpeechFileStream', 'SITooLoud',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPEI_RESERVED5',
    'SpeechAudioFormatGUIDText', 'SRAInterpreter', 'SPEI_SR_PRIVATE',
    'SGDSInactive', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechWaveFormatEx',
    'DISPIDSPTSI_ActiveOffset', 'eLEXTYPE_PRIVATE7',
    'SAFT44kHz16BitMono', 'DISPID_SRProfile', 'SpeechTokenKeyFiles',
    'DISPID_SGRSTNextState', 'SDTPronunciation',
    'DISPID_SGRsFindRule', 'SpeechTokenKeyAttributes',
    'ISpGrammarBuilder', 'SREStreamEnd', 'ISpeechGrammarRule',
    'SpObjectToken', 'DISPID_SRGReset', 'SAFT48kHz8BitMono',
    'SpeechLoadOption', 'SpCustomStream',
    'DISPID_SLGetPronunciations', 'SVP_10', 'SPSUnknown',
    'DISPID_SRRTimes', 'SPEI_UNDEFINED', 'DISPID_SPRsItem',
    'DISPID_SFSOpen', 'DISPID_SGRSTPropertyName', 'SPEI_VOICE_CHANGE',
    'SP_VISEME_19', 'DISPID_SRGetFormat',
    'SAFTCCITT_uLaw_22kHzStereo', 'SSSPTRelativeToStart',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SBSRead',
    'DISPID_SpeechRecoResult2', 'SVP_21', 'SpNotifyTranslator',
    'DISPID_SPEsItem', 'SpeechGrammarState', 'ISpeechPhraseElements',
    'ISpeechGrammarRules', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpeechVoiceStatus', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechPhraseInfo', 'SpeechStreamSeekPositionType',
    'SpeechRunState', 'DISPID_SRCEHypothesis',
    'DISPID_SRCEEnginePrivate', 'DISPID_SGRSTPropertyId',
    'SPEVENTSOURCEINFO', 'DISPID_SRRAlternates', 'ISpNotifySink',
    'SPCT_SLEEP', 'DISPID_SRCEBookmark', 'tagSPTEXTSELECTIONINFO',
    'SDKLDefaultLocation', 'SPEI_RESERVED6',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechObjectTokens', 'DISPID_SLRemovePronunciation',
    'DISPID_SVSRunningState', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPEAudioStreamOffset', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechTokenIdUserLexicon', 'ISpRecoCategory',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPPsCount',
    'DISPID_SRRGetXMLResult', 'SP_VISEME_17', 'DISPID_SRCEAdaptation',
    'SVF_None', 'SRTAutopause', 'SDKLCurrentUser',
    'DISPID_SVAudioOutputStream', 'SpeechTokenShellFolder',
    'DISPID_SPEDisplayAttributes', 'SpPhoneticAlphabetConverter',
    'SSSPTRelativeToEnd', 'SVEViseme', 'SITooSlow',
    'DISPID_SDKCreateKey', 'DISPID_SLWPronunciations',
    '__MIDL_IWinTypes_0009', 'SpWaveFormatEx', 'SVP_13',
    'eWORDTYPE_ADDED', 'DISPID_SOTCreateInstance', 'STSF_FlagCreate',
    'ISpeechAudio', 'SPAUDIOSTATE', 'DISPID_SPERequiredConfidence',
    'SPVPRIORITY', 'DISPID_SMSADeviceId', 'SGSDisabled',
    'eLEXTYPE_PRIVATE18', 'DISPID_SpeechPhraseElements',
    'SPEI_SR_BOOKMARK', 'SRERecoOtherContext',
    'DISPID_SRCEPropertyStringChange', 'ISpeechRecognizerStatus',
    'SAFT48kHz16BitStereo', 'SPRECOGNIZERSTATUS', 'ISpShortcut',
    'DISPID_SLPType', 'SpeechVoiceSkipTypeSentence',
    'SPRECOCONTEXTSTATUS', 'ISpeechMemoryStream',
    'DISPID_SPEs_NewEnum', 'DISPID_SpeechAudio',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRState',
    'SpeechCategoryRecognizers', 'DISPID_SVGetAudioOutputs',
    'eLEXTYPE_PRIVATE3', 'SPEI_ADAPTATION', 'DISPID_SRDisplayUI',
    'DISPID_SADefaultFormat', 'DISPID_SPPName',
    'DISPID_SVSLastBookmarkId', 'ISpNotifyTranslator',
    'ISpeechTextSelectionInformation', 'SPCS_DISABLED',
    'DISPID_SWFEFormatTag', 'DISPID_SRGCommit',
    'SAFTCCITT_ALaw_44kHzMono', 'SVSFNLPSpeakPunc', 'SPPS_Unknown',
    'SpeechMicTraining', 'tagSTATSTG', 'SPEI_SENTENCE_BOUNDARY',
    'ISpNotifySource',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT12kHz8BitStereo', 'DISPID_SVResume',
    'SDA_Consume_Leading_Spaces', 'SpeechVoiceSpeakFlags',
    'eLEXTYPE_USER', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SCSBaseStream',
    'DISPID_SVIsUISupported', 'SRADefaultToActive',
    'ISpeechObjectTokens', 'SPINTERFERENCE_NONE', 'SpStream',
    'SpeechWordPronounceable', 'SVEEndInputStream',
    'DISPID_SpeechAudioStatus', 'LONG_PTR', 'DISPID_SGRInitialState',
    'DISPID_SPEDisplayText', 'SVF_Emphasis', 'SVSFParseMask',
    'SDTAll', 'eLEXTYPE_PRIVATE5', 'DISPID_SRRTOffsetFromStart',
    'SBOPause', 'SVSFlagsAsync', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPSHT_OTHER', 'SAFTExtendedAudioFormat', 'SPEI_VISEME',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPIReplacements',
    'SPCATEGORYTYPE', 'ISpeechObjectToken',
    'SpeechCategoryAppLexicons', 'SPEI_WORD_BOUNDARY', 'SRERequestUI',
    'SpeechTokenContext', 'ISpSerializeState', 'DISPID_SOTCDefault',
    'DISPID_SASetState', 'DISPID_SABIMinNotification',
    'DISPID_SPRulesCount', 'DISPID_SRGetRecognizers',
    'DISPID_SPAsItem', 'SpResourceManager', 'SPSFunction',
    'Speech_StreamPos_Asap', 'SP_VISEME_15',
    'DISPID_SRCreateRecoContext', 'SpMMAudioIn',
    'SWPUnknownWordUnpronounceable', 'SGRSTTWildcard',
    'SVSFParseSapi', 'SAFT24kHz8BitStereo', 'DISPID_SRRRecoContext',
    'ISpeechAudioBufferInfo', 'DISPID_SMSSetData', 'SINone',
    'DISPID_SVPriority', 'DISPID_SLPPhoneIds',
    'DISPID_SRSNumberOfActiveRules', 'SAFTADPCM_44kHzMono',
    'eLEXTYPE_RESERVED6', 'SREStateChange', 'DISPID_SPIEngineId',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SVSLastBookmark',
    'DISPID_SpeechVoiceStatus', 'SREPropertyNumChange',
    'DISPID_SRCRequestedUIType', 'ISpDataKey',
    'DISPID_SPPNumberOfElements', 'DISPID_SVSInputSentenceLength',
    'DISPID_SRGSetWordSequenceData', 'SINoise', 'SPEI_HYPOTHESIS',
    'DISPID_SRCBookmark', 'SPFM_NUM_MODES', 'SPSMF_UPS',
    'DISPID_SPRs_NewEnum', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPSHORTCUTTYPE', 'DISPID_SOTCategory',
    'DISPID_SpeechGrammarRules', 'SAFT11kHz16BitMono',
    'SAFT24kHz8BitMono', 'DISPID_SLGenerationId', 'ISpVoice',
    'SPLO_DYNAMIC', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SDKEnumValues', 'DISPID_SPAs_NewEnum',
    'DISPID_SPARecoResult', 'SPTEXTSELECTIONINFO',
    'SpInProcRecoContext', 'SPEI_RESERVED3', 'SPPHRASEREPLACEMENT',
    'DISPID_SPRuleConfidence', 'DISPID_SRCSetAdaptationData',
    'DISPID_SOTsCount', 'SPCT_SUB_COMMAND', 'SGRSTTRule', 'SVP_17',
    'DISPID_SBSWrite', 'DISPID_SPRText',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SGRsCommitAndSave',
    'SPBO_TIME_UNITS', 'DISPID_SDKGetlongValue',
    'DISPID_SRGetPropertyString', 'SDKLCurrentConfig',
    'DISPID_SPEActualConfidence', 'DISPID_SWFEBitsPerSample',
    'SpeechGrammarRuleStateTransitionType', 'SWTAdded',
    'DISPID_SRCEAudioLevel', 'SAFT11kHz16BitStereo',
    'eLEXTYPE_RESERVED4', 'ISpeechGrammarRuleStateTransitions',
    'SVSFIsNotXML', 'eLEXTYPE_RESERVED8', 'SRSEIsSpeaking',
    'SpSharedRecognizer', 'DISPID_SRSCurrentStreamNumber',
    'eLEXTYPE_RESERVED9', 'SRSActiveAlways',
    'SpeechPropertyResourceUsage', 'SPEI_PHONEME',
    'SRSInactiveWithPurge', 'DISPID_SRGRules', 'DISPID_SVVoice',
    'SPSEMANTICERRORINFO', 'DISPID_SOTRemove', 'eLEXTYPE_PRIVATE12',
    'SVEAudioLevel', 'SDTRule', 'DISPID_SWFEBlockAlign',
    'DISPID_SLWsCount', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechPhraseAlternate', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFT32kHz16BitMono', 'DISPID_SRRTTickCount', 'SPGS_ENABLED',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSTREAMFORMATTYPE',
    'DISPID_SRRTLength', 'DISPID_SGRId', 'SPPS_Noncontent',
    'SP_VISEME_14', 'DISPID_SRCVoice', 'SPRST_INACTIVE',
